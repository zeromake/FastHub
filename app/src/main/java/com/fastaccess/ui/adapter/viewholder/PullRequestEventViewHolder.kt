    ...
    private fun mergedEvent(event: PullRequestTimelineQuery.OnMergedEvent) {
        event.actor?.let {
            stateText.text = SpannableBuilder.builder()
                    ...
                    .append(event.actor)
                    .append(":")
                    .append(event.mergeRefName, BackgroundColorSpan(HtmlHelper.getWindowBackground(PrefGetter.themeType)))
                    .append(" ")
                    .append(ParseDateFormat.getTimeAgo((event.createdAt.toString())))
    ...
    private fun headRefRestoredEvent(event: PullRequestTimelineQuery.OnHeadRefRestoredEvent) {
        event.actor?.let {
            stateText.text = SpannableBuilder.builder()
                    ...
                    .append(it.login)
                    .append(":")
                    .append(event.pullRequest.headRefName, BackgroundColorSpan(HtmlHelper.getWindowBackground(PrefGetter.themeType)))
                    .append(" ")
                    .append("branch")
                    .append(" ")
                    .append(ParseDateFormat.getTimeAgo((event.createdAt.toString())))
    ...
    private fun refForPushedEvent(event: PullRequestTimelineQuery.OnHeadRefForcePushedEvent) {
        event.actor?.let {
            stateText.text = SpannableBuilder.builder()
                    .bold(it.login)
                    .append(" ")
                    .append("reference force pushed to", BackgroundColorSpan(HtmlHelper.getWindowBackground(PrefGetter.themeType)))
                    .append(" ")
    ...
    private fun refDeletedEvent(event: PullRequestTimelineQuery.OnHeadRefDeletedEvent) {
        event.actor?.let {
            stateText.text = SpannableBuilder.builder()
                    ...
                    .append(it.login)
                    .append(":")
                    .append(substring(event.headRefName), BackgroundColorSpan(HtmlHelper.getWindowBackground(PrefGetter.themeType)))
                    .append(" ")
                    .append("branch")
                    .append(" ")
                    .append(ParseDateFormat.getTimeAgo((event.createdAt.toString())))
    ...
    private fun deployedEvent(event: PullRequestTimelineQuery.OnDeployedEvent) {
        event.actor?.let {
            stateText.text = SpannableBuilder.builder()
                    .bold(it.login)
                    .append(" ")
                    .append("made a deployment", BackgroundColorSpan(HtmlHelper.getWindowBackground(PrefGetter.themeType)))
                    .append(" ")
    ...
    private fun forcePushEvent(event: PullRequestTimelineQuery.OnBaseRefForcePushedEvent) {
        event.actor?.let {
            stateText.text = SpannableBuilder.builder()
                    .bold(it.login)
                    .append(" ")
                    .append("force pushed to", BackgroundColorSpan(HtmlHelper.getWindowBackground(PrefGetter.themeType)))
                    .append(" ")
                    .url(substring(event.afterCommit?.oid.toString()))
                    .append(" ")
                    .append(ParseDateFormat.getTimeAgo((event.createdAt.toString())))
