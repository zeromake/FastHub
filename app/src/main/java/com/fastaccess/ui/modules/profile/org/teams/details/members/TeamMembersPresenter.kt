 ...
 */
class TeamMembersPresenter : BasePresenter<TeamMembersMvp.View>(),
    TeamMembersMvp.Presenter {
    ...
    override fun onCallApi(page: Int, parameter: Long?): Boolean {
        ...
        makeRestCall(getOrgService(isEnterprise).getTeamMembers(parameter, page)
        ) { response ->
