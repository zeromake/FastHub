...
class ProfileFollowersFragment :
    BaseFragment<ProfileFollowersMvp.View, ProfileFollowersPresenter>(),
    ProfileFollowersMvp.View {
    @JvmField
    ...
    override fun providePresenter(): ProfileFollowersPresenter {
        return ProfileFollowersPresenter()
    }
    ...
    companion object {
        fun newInstance(username: String): ProfileFollowersFragment {
            val view = ProfileFollowersFragment()
