 ...
 */
class ProfileReposFragment : BaseFragment<ProfileReposMvp.View, ProfileReposPresenter>(),
    ProfileReposMvp.View, ProfileReposFilterChangeListener {
    @JvmField
    ...
    override fun providePresenter(): ProfileReposPresenter {
        return ProfileReposPresenter()
    }
    ...
    override fun onSortOptionSelected(selectedSortOption: String?) {
        presenter!!.onSortOptionSelected(selectedSortOption)
    }

    override fun onSortDirectionSelected(selectedSortDirection: String?) {
        presenter!!.onSortDirectionSelected(selectedSortDirection)
    }
    ...
    companion object {
        fun newInstance(username: String): ProfileReposFragment {
            val view = ProfileReposFragment()
