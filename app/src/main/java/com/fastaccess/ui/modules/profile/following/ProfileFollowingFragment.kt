...
class ProfileFollowingFragment :
    BaseFragment<ProfileFollowingMvp.View, ProfileFollowingPresenter>(),
    ProfileFollowingMvp.View {
    @JvmField
    ...
    override fun onFragmentCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = UsersAdapter(presenter!!.following)
        adapter!!.listener = presenter
        recycler!!.adapter = adapter
        recycler!!.addOnScrollListener(loadMore)
        recycler!!.addKeyLineDivider()
        if (presenter!!.following.isEmpty() && !presenter!!.isApiCalled) {
            onRefresh()
        }
        fastScroller!!.attachRecyclerView(recycler!!)
    }

    override fun providePresenter(): ProfileFollowingPresenter {
        return ProfileFollowingPresenter()
    }
    ...
    companion object {
        fun newInstance(username: String): ProfileFollowingFragment {
            val view = ProfileFollowingFragment()
